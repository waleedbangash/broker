            ...
            <div class="card-body">
                <form method="post" action="{{route('admin.bank.update',$bank->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('bank_name') ? 'is-invalid' : '' }}" type="text" name="bank_name" id="bank_name" value="{{$bank->bank_name}}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('account_number') ? 'is-invalid' : '' }}" type="text" name="account_number" id="account_number" value="{{$bank->account_number }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('organization_name') ? 'is-invalid' : '' }}" type="text" name="organization_name" id="organization_name" value="{{$bank->organization_name}}" required>
